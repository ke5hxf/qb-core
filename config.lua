...
QBConfig.Money.PayCheckTimeOut = 15 -- The time in minutes that it will give the paycheck default 10
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 3.2 -- default 4.2 Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 2.9 -- default 3.8 Rate at which thirst goes down.
...
QBConfig.Server.Discord = "https://discord.gg/Ppv2ygtN6g" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = { 'god', 'admin', 'mod', 'addnewtypehere' } -- Add as many groups as you want here after creating them in your server.cfg
